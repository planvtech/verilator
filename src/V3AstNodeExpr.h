...
class AstSIntersect final : public AstNodeBiop {
    // Sequence 'intersect' (IEEE 1800-2023 16.9.6): both operand sequences must match
    // with the same length. AND with length restriction.
    // For boolean operands, lowered to AstLogAnd.
public:
